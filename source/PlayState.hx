...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['bolacha cristal', 0.2], //From 0% to 19%
		['Merda', 0.4], //From 20% to 39%
		['Burro', 0.5], //From 40% to 49%
		['vc é medio', 0.6], //From 50% to 59%
		['geração z', 0.69], //From 60% to 68%
		['Nao sei', 0.7], //69%
		['parece eu', 0.8], //From 70% to 79%
		['Eminem', 0.9], //From 80% to 89%
		['BfReiDelas@gmail.com', 1], //From 90% to 99%
		['BfReiDelas@gmail.com', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "ROBOZINHO DA PETROBRAS", 32);
